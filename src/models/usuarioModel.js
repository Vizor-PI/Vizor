...
function autenticar(email, senha) {
    ...
    var instrucaoSql = `
        SELECT us.id, us.nome, us.email, empresa.codigoAtivacao FROM usuario AS us INNER JOIN empresa ON empresa.id = us.fkEmpresa WHERE email = '${email}' AND senha = '${senha}';
    `;
